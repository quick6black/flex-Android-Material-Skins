...
package spark.skins.android5
{
	...
	[Style(name="trackColor", type="uint", format="Color", inherit="yes")]	
	/**
	...
	public class HSliderTrackSkin extends MobileSkin
	{
		...
		override protected function drawBackground(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			graphics.beginFill(trackColor, 1);
			graphics.drawRect(visibleTrackOffset, 0, unscaledTrackWidth, trackHeight);
			graphics.endFill();
		}
	}
}